...
const columns = defineVaDataTableColumns([
  ...
  { label: t('protein.meta_file'), key: 'meta_file' },
...
const props = defineProps({
  items: {
    type: Array as PropType<AdminProteinItem[]>,
    required: true,
  },
...
const emit = defineEmits<{
  (event: 'download-item', item: AdminProteinItem, type: RawDataType): void
  (event: 'edit-item', item: AdminProteinItem): void
  (event: 'view-item', item: AdminProteinItem): void
  (event: 'download-report', item: AdminProteinItem): void
}>()
    ...
    <template #cell(meta_file)="{ rowData }">
      <div>
        ...
        <VaButton
          ...
          @click="emit('download-item', rowData as AdminProteinItem, 'meta')"
        />
      </div>
    </template>
    ...
    <template #cell(exp_file)="{ rowData }">
      <div>
        ...
        <VaButton
          ...
          @click="emit('download-item', rowData as AdminProteinItem, 'exp')"
        />
      </div>
    </template>
    ...
    <template #cell(actions)="{ rowData }">
      <div class="flex gap-2 justify-end">
        <VaButton
          ...
          @click="emit('view-item', rowData as AdminProteinItem)"
        />
        <VaButton
          preset="primary"
          size="small"
          ...
          @click="emit('download-report', rowData as AdminProteinItem)"
        />
        <VaButton
          preset="primary"
          size="small"
          ...
          @click="emit('edit-item', rowData as AdminProteinItem)"
        />
      </div>
    </template>
  </VaDataTable>
