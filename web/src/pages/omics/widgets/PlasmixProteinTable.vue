...
import { PlasmixProteinItem } from '../types'
...
const columns = defineVaDataTableColumns([
  ...
  { label: t('plasmix_protein.technology'), key: 'technology', sortable: true },
...
const props = defineProps({
  items: {
    type: Array as PropType<PlasmixProteinItem[]>,
    required: true,
  },
...
const emit = defineEmits<{
  (event: 'edit-item', item: PlasmixProteinItem): void
  (event: 'download-item', item: PlasmixProteinItem): void
}>()
...
<template>
  ...
  >
    ...
    <template #cell(technology)="{ rowData }">
    ...
    <template #cell(actions)="{ rowData }">
      <div class="flex gap-2 justify-end">
        <VaButton
          ...
          @click="$emit('edit-item', rowData as PlasmixProteinItem)"
        />
        <VaButton
          preset="primary"
          size="small"
          ...
          @click="onItemDownload(rowData as PlasmixProteinItem)"
        />
      </div>
    </template>
  </VaDataTable>
